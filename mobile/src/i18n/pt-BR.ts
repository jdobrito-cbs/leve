...
const ptBR = {
  ...
  cloudAccount: {
    ...
    body: 'Entrar com Apple ou Google serve só para preencher seu nome e e-mail no perfil. Você pode usar o app normalmente sem conta.',
    ...
    skipHint: 'Sem conta, seus dados ficam só neste aparelho.',
